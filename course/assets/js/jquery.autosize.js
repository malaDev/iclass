...
(function ($, undefined) {
    var 
    hidden = 'hidden',
    copy = '<textarea style="position:absolute; box-sizing:border-box; top:-9999px; left:-9999px; right:auto; bottom:auto; word-wrap:break-word; height:0 !important; min-height:0 !important; overflow:hidden">',
            ...
            return this.each(function () {
                ...
                function adjust() {
                    ...
                    if (!active) {
                        ...
                        ta.style.height = ta.style.minHeight = ta.style.maxHeight = height + 6 + 'px';
